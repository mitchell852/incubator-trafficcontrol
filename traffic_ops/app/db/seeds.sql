...
-- service categories
insert into api_capability (http_method, route, capability) values ('GET', 'service-categories', 'service-categories-read') ON CONFLICT (http_method, route, capability) DO NOTHING;
insert into api_capability (http_method, route, capability) values ('POST', 'service-categories', 'service-categories-write') ON CONFLICT (http_method, route, capability) DO NOTHING;
insert into api_capability (http_method, route, capability) values ('PUT', 'service-categories/*', 'service-categories-write') ON CONFLICT (http_method, route, capability) DO NOTHING;
insert into api_capability (http_method, route, capability) values ('DELETE', 'service-categories/*', 'service-categories-write') ON CONFLICT (http_method, route, capability) DO NOTHING;
-- stats
